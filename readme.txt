...
amit@VM-M20AIE213-1:~/WebApp/temp$ sudo docker ps -a
CONTAINER ID   IMAGE                    COMMAND                  CREATED             STATUS                           PORTS     NAMES
401ed610bd26   cloud_m20aie213:v1.0.0   "gunicorn --bind 0.0…"   19 minutes ago      Exited (0) 17 minutes ago                  youthful_raman
1fd39fd8a66b   cloud_m20aie213:v1.0.0   "gunicorn --bind 0.0…"   20 minutes ago      Exited (0) 19 minutes ago                  competent_keldysh
a463ab545eef   m20aie213:v1.0.0         "gunicorn --bind 0.0…"   About an hour ago   Exited (0) About an hour ago               festive_shtern
85a41188c97f   m20aie213:v1.0.0         "gunicorn --bind 0.0…"   About an hour ago   Exited (0) About an hour ago               quirky_ardinghelli
c5aa3e8b7a3c   amit-docker:latest       "gunicorn --bind 0.0…"   About an hour ago   Exited (0) About an hour ago               pedantic_leavitt
7468ecd0101b   amit-docker:latest       "gunicorn --bind 0.0…"   About an hour ago   Exited (0) About an hour ago               kind_hodgkin
1daa436a8ade   e5118d0aa44c             "/bin/sh -c 'apt-get…"   About an hour ago   Exited (100) About an hour ago             magical_margulis
4e166ef08e80   d5c678f9b3ba             "/bin/sh -c 'apt-get…"   About an hour ago   Exited (1) About an hour ago               ecstatic_kepler
68e23a39672c   8bd004befd1d             "/bin/sh -c 'python3…"   About an hour ago   Exited (1) About an hour ago               recursing_jepsen
e65a7aefd793   d5c678f9b3ba             "/bin/sh -c 'apt-get…"   About an hour ago   Exited (100) About an hour ago             wizardly_hermann
b82b3497e17c   e5118d0aa44c             "/bin/sh -c 'apt-get…"   About an hour ago   Exited (100) About an hour ago             hardcore_turing
3f9069805338   python-docker:v1.0.0     "gunicorn --bind 0.0…"   2 hours ago         Exited (0) About an hour ago               nervous_sanderson
a7767536aacc   python-docker:v1.0.0     "gunicorn --bind 0.0…"   2 hours ago         Exited (0) 2 hours ago                     intelligent_franklin
6c9a5a3c19e4   34da5e2592de             "/bin/sh -c 'python …"   2 hours ago         Exited (127) 2 hours ago                   relaxed_villani
d176bf4cd90e   27908b66d0ea             "/bin/sh -c 'python …"   2 hours ago         Exited (1) 2 hours ago                     magical_chatterjee
dd8948d5ac3f   hello-world              "/hello"                 2 hours ago         Exited (0) 2 hours ago                     priceless_feynman
